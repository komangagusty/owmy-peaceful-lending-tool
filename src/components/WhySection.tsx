...
const WhySection = () => {
  ...
  const handleWaitlistClick = () => {
    trackEvent("waitlist_click", {
      location: "why_section",
      button_type: "primary",
      link_url: t.common.tallyFormUrl
    });
  };
  return (
      ...
      <div className="section-container">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            <a 
              href={t.common.tallyFormUrl} target="_blank" rel="noopener noreferrer" className="bg-white text-owwy-primary hover:bg-gray-100 transition-colors px-8 py-3 rounded-lg font-medium text-lg"
